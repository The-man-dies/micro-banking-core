...
const CountdownDisplay = ({
  ...
  expiresAt: string;
  status: "active" | "expired" | "withdraw_only";
}) => {
  ...
  return (
    <div className="bg-base-200/50 rounded-xl p-4 mb-6">
      ...
      <div className="flex items-center gap-2">
        ...
        <span
          className={`stat-value text-xl ${countdown.isExpired ? "text-error" : "text-primary"}`}
        >
          {countdown.formatted}
        </span>
      </div>
  ...
  return (
    <>
            ...
            {clients.map((client) => (
              <tr key={client.id} className="hover">
                <td>
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <div className="text-xs text-base-content/50 opacity-50">
                        ID: #{client.id}
                      </div>
                    </div>
                  </div>
                ...
                <td className="text-center">
                  <div
                    className={`badge ${client.status === "active" ? "badge-success" : "badge-error"} gap-1 text-white`}
                  >
          ...
          >
            ...
            <div className="p-6 overflow-y-auto custom-scrollbar">
                ...
                <div className="avatar placeholder">
                  <div className="bg-neutral text-neutral-content rounded-2xl w-20 flex items-center justify-center">
                    <span className="text-2xl font-bold">
                      {viewingClient.firstname[0]}
                      {viewingClient.lastname[0]}
                    </span>
                  </div>
                </div>
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-1">
                    <span
                      className={`badge ${viewingClient.status === "active" ? "badge-success" : "badge-error"} badge-sm text-white`}
                    >
              ...
              <div className="grid grid-cols-2 gap-4 mb-6">
                <div className="stat bg-base-200/50 rounded-xl p-4">
                  ...
                  <div className="stat-value text-xl">
                    {viewingClient.accountBalance.toLocaleString()}{" "}
                    <span className="text-xs font-normal opacity-50">FCFA</span>
                  </div>
                </div>
                <div className="stat bg-primary/10 rounded-xl p-4">
                  <div className="stat-title text-xs uppercase tracking-wider text-primary">
                    Engagement
                  </div>
                  <div className="stat-value text-xl text-primary">
                    {viewingClient.montantEngagement?.toLocaleString() || 0}{" "}
                    <span className="text-xs font-normal opacity-50">FCFA</span>
                  </div>
                </div>
              </div>
              ...
              {viewingClient.accountExpiresAt && (
                <CountdownDisplay
                  expiresAt={viewingClient.accountExpiresAt}
                  status={viewingClient.status}
                />
              )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <div className="font-medium">
                      Agent ID #{viewingClient.agentId}
                    </div>
                  </div>
                </div>
                <div className="flex items-center gap-3">
            ...
            <div className="p-6 border-t border-base-300 bg-base-200/30 rounded-b-2xl flex gap-3">
              ...
              <button
                onClick={() => {
                  setFinancialClient(viewingClient);
                  setViewingClient(null);
                }}
          ...
          >
            <div className="p-6 text-center border-b border-base-300">
              ...
              <p className="text-base-content/60 text-sm mt-1">
                Pour {financialClient.firstname} {financialClient.lastname}
              </p>
            </div>
            ...
            <div className="p-6 grid gap-3">
              <button
                onClick={() => {
                  onFinancialOp(financialClient, "deposit");
              ...
              <button
                onClick={() => {
                  onFinancialOp(financialClient, "payout");
                  setFinancialClient(null);
                }}
              ...
              <button
                onClick={() => {
                  onFinancialOp(financialClient, "renew");
                  setFinancialClient(null);
                }}
              ...
              >
                <RefreshCw
                  size={18}
                  className={
                    financialClient.status !== "active" ? "animate-pulse" : ""
                  }
                />
                Renouveler compte
              </button>
      ...
      {showDeleteModal && (
        ...
        >
          <div
            className="bg-base-100 w-full max-w-sm rounded-2xl shadow-2xl animate-in fade-in zoom-in duration-200"
            onClick={(e) => e.stopPropagation()}
          >
            ...
            <div className="p-6 border-t border-base-300 flex gap-3 bg-base-200/30 rounded-b-2xl">
              <button className="btn btn-ghost flex-1" onClick={cancelDelete}>
                Annuler
              </button>
