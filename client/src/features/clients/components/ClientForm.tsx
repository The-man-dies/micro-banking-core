...
export type ClientFormData = Omit<
  Client,
  "id" | "accountBalance" | "accountExpiresAt" | "status"
>;
...
export default function ClientForm({ onClose, onSubmit, initialData }: Props) {
  ...
  useEffect(() => {
    ...
    fetchAgents();
  }, [initialData]); // Changed from [initialData] to [] to ensure fetch on mount/open
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {error && (
              <div
                role="alert"
                className="alert alert-error md:col-span-2 shadow-sm text-sm"
              >
                <svg
            ...
            {!hasAgents && (
              <div
                role="alert"
                className="alert alert-warning md:col-span-2 text-sm"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  className="stroke-current shrink-0 h-6 w-6"
                ...
                <span>
                  Attention : Aucun agent disponible. Veuillez en créer un avant
                  de continuer.
                </span>
              </div>
            )}
            ...
            <div className="divider md:col-span-2 text-primary/80 font-medium">
